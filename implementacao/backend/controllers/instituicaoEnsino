const { InstituicaoEnsino: InstituicaoEnsinoModel } = require("../models/InstituicaoEnsino")
...
const InstituicaoEnsinoController = {
    create: async (req, res) => {
        ...
        try {
            ...
            res.status(201).json({ response, msg: "InstituicaoEnsino cadastrado com sucesso!" })
        } catch (error) {
            console.log(error)
        }
    },
    ...
    delete: async (req, res) => {
        try {
            ...
            const deletedInstituicaoEnsino = await InstituicaoEnsinoModel.findByIdAndDelete(id)

            res.status(200).json({ deletedInstituicaoEnsino, msg: "InstituicaoEnsino excluido com sucesso!" })
        } catch (error) {
            console.log(error)
        }
    },
    update: async (req, res) => {
        try {
            ...
            res.status(200).json({ aluno, msg: "InstituicaoEnsino atualizado com sucesso!" })
